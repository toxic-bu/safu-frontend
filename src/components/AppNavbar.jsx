...
const AppNavbar = () => {
    ...
    return (
        <nav className="flex justify-between items-center md:pt-2 md:px-20 pt-1">
            ...
            {currentAccount ? (
                <div className="bg-[#fff] px-3 border-2 border-white rounded-full cursor-pointer hover:bg-[#C3FBD8] text-black text-sm mr-2">
                ...
                <button
                    ...
                    className="bg-[#fff] px-3 border-2 border-white rounded-full cursor-pointer hover:bg-[#C3FBD8] text-black text-sm mr-2"
                >
                    Connect wallet
                </button>
            )}
